...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/zyjiad/Vless2sub/main/addressesapi.txt',
	...
	'https://raw.githubusercontent.com/smjcxf/yxip/main/yxip.txt',
...
let subconfig = "https://raw.githubusercontent.com/zyjiad/Vlesstunnel/main/Clash/config/ACL4SSR_Online_Full_MultiMode.ini";
...
async function getAddressesapi() {
	...
	for (const apiUrl of addressesapi) {
		try {
			...
			const regex = /^(([\da-fA-F]{1,4}:){7}[\da-fA-F]{1,4}|[\d\.]{7,15})(:\d+)?(#.*)?$/;
